...
const s: Record<string, React.CSSProperties> = {
  ...
  addBtn: { background: '#1A56DB', color: '#fff', border: 'none', borderRadius: 10, padding: '10px 20px', fontSize: 14, fontWeight: 600, cursor: 'pointer' },
  ...
  filterBtn: { padding: '6px 16px', borderRadius: 20, border: '1px solid #E5E7EB', background: '#fff', cursor: 'pointer', fontSize: 13, color: '#6B7280' },
  filterActive: { background: '#1A56DB', color: '#fff', border: '1px solid #1A56DB' },
  ...
  tableHeader: { display: 'grid', gridTemplateColumns: '120px 1fr 130px 100px 140px 24px', gap: 12, padding: '12px 20px', background: '#F9FAFB', fontSize: 12, fontWeight: 600, color: '#6B7280', borderBottom: '1px solid #F3F4F6' },
  ...
  quoteNum: { fontSize: 13, fontWeight: 600, color: '#1A56DB' },
  clientName: { fontSize: 14, color: '#111827' },
  ...
  arrow: { fontSize: 18, color: '#9CA3AF', textAlign: 'center' },
};
