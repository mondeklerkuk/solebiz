...
const s: Record<string, React.CSSProperties> = {
  ...
  colHeader: { borderRadius: 10, padding: '8px 12px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 10 },
  colLabel: { fontSize: 13, fontWeight: 600, letterSpacing: '-0.1px' },
  colCount: { fontSize: 13, fontWeight: 700, opacity: 0.7 },
  cards: { display: 'flex', flexDirection: 'column', gap: 10 },
  empty: { color: '#9CA3AF', fontSize: 13, textAlign: 'center', padding: '20px 0' },
  card: { background: '#fff', borderRadius: 14, padding: 14, boxShadow: '0 1px 3px rgba(0,0,0,0.06), 0 1px 2px rgba(0,0,0,0.04)', cursor: 'pointer', border: '1px solid rgba(0,0,0,0.04)' },
  cardTitle: { fontSize: 14, fontWeight: 600, color: '#1C1C1E', marginBottom: 4 },
  cardClient: { fontSize: 12, color: '#8E8E93', marginBottom: 4 },
  cardDesc: { fontSize: 12, color: '#8E8E93', marginBottom: 6, lineHeight: '1.4' },
  ...
  moveBtn: { fontSize: 11, padding: '4px 9px', borderRadius: 8, border: '1px solid #E5E5EA', background: '#F2F2F7', cursor: 'pointer', color: '#3C3C43', whiteSpace: 'nowrap' },
};
