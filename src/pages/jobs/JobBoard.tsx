...
const s: Record<string, React.CSSProperties> = {
  ...
  cardTitle: { fontSize: 14, fontWeight: 600, color: '#0F172A', marginBottom: 4 },
  cardClient: { fontSize: 12, color: '#64748B', marginBottom: 4 },
  cardDesc: { fontSize: 12, color: '#94A3B8', marginBottom: 6, lineHeight: '1.4' },
  cardDate: { fontSize: 12, color: '#64748B', marginBottom: 8 },
  ...
  moveBtn: { fontSize: 11, padding: '3px 8px', borderRadius: 6, border: '1px solid #E5E7EB', background: '#F8FAFC', cursor: 'pointer', color: '#1E293B', whiteSpace: 'nowrap' },
};
